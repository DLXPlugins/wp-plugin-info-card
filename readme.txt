...
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-pic">[wp-pic] shortcode and parameters</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-pic-query">[wp-pic-query] shortcode and parameters</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-pic-site-plugins">[wp-pic-site-plugins] shortcode and parameters</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-pic-plugin-screenshot">[wp-pic-plugin-screenshots] shortcode and parameters</a>.
* <a href="https://docs.mediaron.com/products/wp-plugin-info-card/shortcodes/github-info-card">[github-info-card] shortcode and parameters</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-pic-badges">[wp-pic-badges] shortcode and parameters</a>.

== Quick Links (Block Documentation) ==

* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-plugin-info-card-block">WP Plugin Info Card block</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-plugin-info-card-query-block">WP Plugin Info Card Query block</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/site-plugins-card-grid">Site Plugins Card Grid block</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/plugin-screenshots-info-card">WP Plugin Info Card Plugin Screenshots block</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/the-github-info-cards-block">GitHub Info Cards Grid block</a>.
* <a href="https://docs.mediaron.com/product/wp-plugin-info-card/badges-block">Profile Badges Block</a>.
...
For <a href="https://docs.mediaron.com/product/wp-plugin-info-card/easy-digital-downloads-integration/">WP Plugin Info Card to work properly with EDD</a> the following add-ons are recommended:
...
See shortcode usage <a href="https://docs.mediaron.com/product/wp-plugin-info-card/wp-pic">for custom titles</a>.

= What layouts/color schemes come with the plugin? =

For the main plugin card block/shortcode, there are <a href="https://docs.mediaron.com/product/wp-plugin-info-card/layouts">five different layouts</a>, and <a href="https://docs.mediaron.com/product/wp-plugin-info-card/schemes">fourteen color schemes</a>.
...
= 6.0.0 =
* Released 2025-08-19
* New feature: Custom Plugin Cards (<a href="https://dlxplugins.com/announcements/wp-plugin-info-card-6-0-released-with-custom-plugin-cards/">read the 6.0.0 annnouncement</a>). Create, import, and export these custom plugins.
* New feature: New margin controls on the plugin cards for better appearance.
* New feature: Added transforms to the main card block and the screenshots block.
* Bug fix: A lot of code cleanup has been done.
* Bug fix: Font sizes on title cards were too large and had too much padding.
* Bug fix: Resolved block icons not rendering correctly.
