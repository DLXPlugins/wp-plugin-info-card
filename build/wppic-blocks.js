...
var PluginScreenshotsInfoCard = function PluginScreenshotsInfoCard(a) {
  ...
  var V = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(b.align),
    ...
    X = W[0],
    Y = W[1];
  var Z = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(false),
    $ = _slicedToArray(Z, 2),
    _ = $[0],
    aa = $[1];
  var ba = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(b.screen),
    ca = _slicedToArray(ba, 2),
    da = ca[0],
    ea = ca[1];
  var fa = function loadData() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get(a + "?type=".concat(f, "&slug=").concat(encodeURIComponent(j))).then(function (a) {
      ...
      U(a.data.data);
      aa(a.data.data.hasOwnProperty('screenshots'));
      s(false);
    });
  };
  ...
  var na = 'card' === H ? 'wp-pic-card' : H;
  var oa = r ? 'wp-pic-spin' : '';
  var pa = /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
    title: __('Layout', 'wp-plugin-info-card')
  }, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(SelectControl, {
    label: __('Scheme', 'wp-plugin-info-card'),
    options: la,
   ...
   */
  var ra = function getCurrentScreen() {
  ...
  if (r) {
    return /*#__PURE__*/React.createElement("div", qa, /*#__PURE__*/React.createElement("div", {
      className: "wppic-loading-placeholder"
    }, /*#__PURE__*/React.createElement("div", {
      className: "wppic-loading"
  ...
  return /*#__PURE__*/React.createElement("div", qa, ra());
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PluginScreenshotsInfoCard);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ScreenImageProcessor);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ScreenNoImages);
...
var ScreenPluginPreview = function ScreenPluginPreview(a) {
  var b = a.attributes,
    c = a.setAttributes;
  var d = b.assetData,
    e = b.enableScreenshots,
    f = b.maxHeight,
    g = b.imageSize,
    h = b.enableRoundedIcon,
    i = b.iconStyle,
    j = b.enableContextMenu,
    k = b.pluginTitle,
    l = b.colorTheme;

  // Set the local inspector controls.
  var m = /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
  ...
  })), e && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
  ...
  var n = /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarButton, {
    icon: "edit",
  ...
  var o = /*#__PURE__*/React.createElement(React.Fragment, null, n, /*#__PURE__*/React.createElement(_templates_PluginScreenshots__WEBPACK_IMPORTED_MODULE_8__["default"], {
    assetData: d,
    attributes: b
  }));
  return /*#__PURE__*/React.createElement(React.Fragment, null, m, o);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ScreenPluginPreview);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SlugEntryScreen);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LoadingImageProgressScreen);
...
var PluginScreenshots = function PluginScreenshots(a) {
  ...
  var d = a.assetData,
    e = a.attributes;
  var f = e.maxHeight;
  var g = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null),
    h = _slicedToArray(g, 2),
    i = h[0],
    j = h[1];
  var k = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(d.rating),
    l = _slicedToArray(k, 2),
    m = l[0],
    n = l[1];
  var o = classnames__WEBPACK_IMPORTED_MODULE_0___default()({
    large: true,
    'wp-pic-plugin-screenshots-wrapper': true,
    'wp-pic-card': true
  });
  var p = classnames__WEBPACK_IMPORTED_MODULE_0___default()("wppic-plugin-screenshot-theme-".concat(e.colorTheme), {
    'wp-pic-plugin-screenshots': true,
    'wp-pic-screenshots': true,
    large: true,
    plugin: true,
    'wp-pic-has-screenshots': null !== i && i.length > 0 ? true : false
  });
  // WordPress Requires.
  var q = d.requires;
  if (q && validator_lib_isNumeric__WEBPACK_IMPORTED_MODULE_5___default()(q)) {
    q = 'WP ' + q + '+';
  } else {
    q = d.tested;
  }
  ...
  if (d.hasOwnProperty('icons')) {
    if (d.icons.hasOwnProperty('svg')) {
      ...
      r = wppic.wppic_plugin_icon_default;
    }
  }
  var s = (b = d === null || d === void 0 ? void 0 : d.local_screenshots) !== null && b !== void 0 ? b : [];
  var t = {
    backgroundImage: "url(".concat(r, ")"),
    backgroundRepeat: 'no-repeat',
    backgroundSize: 'cover'
  };
  var u = new HtmlToReactParser();
  var v = m / 20;
  return /*#__PURE__*/React.createElement("div", {
    className: o
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, u.parse(d.short_description))), /*#__PURE__*/React.createElement("footer", {
    className: "wp-pic-plugin-screenshots-footer"
  }, Object.values(s).length > 0 && e.enableScreenshots && /*#__PURE__*/React.createElement("div", {
    ...
    options: (c = {
      ...
      perMove: 1,
      arrows: Object.values(s).length > 3 ? true : false,
      pagination: false,
      drag: true,
      autoplay: false,
      lazyload: 'nearby'
    }, _defineProperty(c, "perPage", Object.values(s).length < 2 ? 1 : 2), _defineProperty(c, "mediaQuery", 'min'), _defineProperty(c, "breakpoints", {
      '500': {
  ...
  }, Object.values(s).map(function (a, b) {
    ...
    className: "wp-pic-plugin-screenshots-meta-item-label"
  }, __('Requires', 'wp-plugin-info-card'), " ", "".concat(q))), /*#__PURE__*/React.createElement("div", {
    className: "wp-pic-plugin-screenshots-meta-item"
  }, /*#__PURE__*/React.createElement("div", {
    className: "wp-pic-plugin-screenshots-meta-item-svg"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PluginScreenshots);
...
"use strict";
module.exports = JSON.parse('{"_from":"axios@^0.21.1","_id":"axios@0.21.4","_inBundle":false,"_integrity":"sha512-ut5vewkiu8jjGBdqpM44XxjuCjq9LAKeHVmoVfHVzy8eHgxxq8SbAVQNovDA8mVi05kP0Ea/n/UzcSHcTJQfNg==","_location":"/axios","_phantomChildren":{},"_requested":{"type":"range","registry":true,"raw":"axios@^0.21.1","name":"axios","escapedName":"axios","rawSpec":"^0.21.1","saveSpec":null,"fetchSpec":"^0.21.1"},"_requiredBy":["#DEV:/"],"_resolved":"https://registry.npmjs.org/axios/-/axios-0.21.4.tgz","_shasum":"c67b90dc0568e5c1cf2b0b858c43ba28e2eda575","_spec":"axios@^0.21.1","_where":"/Users/ronaldhuereca/Sites/localhost/mrlocal/wp-content/plugins/wp-plugin-info-card","author":{"name":"Matt Zabriskie"},"browser":{"./lib/adapters/http.js":"./lib/adapters/xhr.js"},"bugs":{"url":"https://github.com/axios/axios/issues"},"bundleDependencies":false,"bundlesize":[{"path":"./dist/axios.min.js","threshold":"5kB"}],"dependencies":{"follow-redirects":"^1.14.0"},"deprecated":false,"description":"Promise based HTTP client for the browser and node.js","devDependencies":{"coveralls":"^3.0.0","es6-promise":"^4.2.4","grunt":"^1.3.0","grunt-banner":"^0.6.0","grunt-cli":"^1.2.0","grunt-contrib-clean":"^1.1.0","grunt-contrib-watch":"^1.0.0","grunt-eslint":"^23.0.0","grunt-karma":"^4.0.0","grunt-mocha-test":"^0.13.3","grunt-ts":"^6.0.0-beta.19","grunt-webpack":"^4.0.2","istanbul-instrumenter-loader":"^1.0.0","jasmine-core":"^2.4.1","karma":"^6.3.2","karma-chrome-launcher":"^3.1.0","karma-firefox-launcher":"^2.1.0","karma-jasmine":"^1.1.1","karma-jasmine-ajax":"^0.1.13","karma-safari-launcher":"^1.0.0","karma-sauce-launcher":"^4.3.6","karma-sinon":"^1.0.5","karma-sourcemap-loader":"^0.3.8","karma-webpack":"^4.0.2","load-grunt-tasks":"^3.5.2","minimist":"^1.2.0","mocha":"^8.2.1","sinon":"^4.5.0","terser-webpack-plugin":"^4.2.3","typescript":"^4.0.5","url-search-params":"^0.10.0","webpack":"^4.44.2","webpack-dev-server":"^3.11.0"},"homepage":"https://axios-http.com","jsdelivr":"dist/axios.min.js","keywords":["xhr","http","ajax","promise","node"],"license":"MIT","main":"index.js","name":"axios","repository":{"type":"git","url":"git+https://github.com/axios/axios.git"},"scripts":{"build":"NODE_ENV=production grunt build","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js","examples":"node ./examples/server.js","fix":"eslint --fix lib/**/*.js","postversion":"git push && git push --tags","preversion":"npm test","start":"node ./sandbox/server.js","test":"grunt test","version":"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json"},"typings":"./index.d.ts","unpkg":"dist/axios.min.js","version":"0.21.4"}');
