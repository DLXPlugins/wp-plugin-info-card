...
/* harmony import */ var _media_uploader_helper__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./media-uploader-helper */ "./src/blocks/CustomInfoCard/media-uploader-helper.js");
...
var CustomInfoCard = function CustomInfoCard(a) {
  ...
  var D = useState(b.align),
    ...
    F = E[0],
    G = E[1];
  var H = useState(b.currentScreen),
  ...
  var L = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  var M = function getScreenOneImages() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      onClick: function onClick(a) {
        var b = a.target;
        (0,_media_uploader_helper__WEBPACK_IMPORTED_MODULE_13__["default"])(a, {
          suggestedWidth: 512,
          suggestedHeight: 512,
  ...
  var Q = /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
  ...
  var S = function getInspectorControls() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, Q, /*#__PURE__*/React.createElement(BlockControls, null, /*#__PURE__*/React.createElement(ToolbarGroup, null, /*#__PURE__*/React.createElement(ToolbarButton, {
      icon: "edit",
      title: __('Edit and Configure', 'wp-plugin-info-card'),
      onClick: function onClick() {
        return i(true);
  ...
  var T = function screeenWizardStart() {
    ...
    }, /*#__PURE__*/React.createElement("p", null, __('A wizard will walk you through all the steps and data the plugin needs to display an info card.', 'wp-plugin-info-card'))), L)));
  };
  var U = function wizardScreenOneImageSelect() {
    return null;
  };
  console.log(J);
  var V = function getScreenComponents() {
    switch (J) {
      case 'wizardStart':
        return T();
        break;
  ...
  return /*#__PURE__*/React.createElement("div", R, V());
};
/* harmony default export */ __webpack_exports__["default"] = (CustomInfoCard);

/***/ }),

/***/ "./src/blocks/CustomInfoCard/media-uploader-helper.js":
/*!************************************************************!*\
  !*** ./src/blocks/CustomInfoCard/media-uploader-helper.js ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var wpInfoCardImageCrop = function wpInfoCardImageCrop(a, b) {
  var __ = wp.i18n.__;
  var c = {
    id: '',
    attachmentId: 0,
  ...
  var d = _objectSpread(_objectSpread({}, c), b);
  var f = function cropOptions(a, b) {
    var c = b.get('control');
    var e = a.get('width');
    var f = a.get('height');
    console.log(b);
    var g = parseInt(c.params.width, 10);
    var h = parseInt(c.params.height, 10);
    var i = g / h;
    var j = e / f;
    var k = i === j;
    b.set('canSkipCrop', k);
  ...
  var g = {
    ...
    params: {
      flex_width: false,
      flex_height: false,
      width: d.suggestedWidth,
      height: d.suggestedHeight
    }
  };
  var h = function setAttachmentImage(a) {
    var b = element.querySelector('.course-maker-img-container a');
    b.innerHTML = "<img src=\"".concat(a.url, "\" />");
  };
  var i = function saveCropped(a, b) {
    fetch(ajaxurl, {
      method: 'POST',
      ...
      if (a.success) {
        d.callback(a.data);
        d.attachmentId = a.data.attachment_id;
      }
    });
  };
  var j = function handleUpload(a) {
    a.preventDefault();
    console.log(g);
    var b = wp.media({
      button: {
    ...
    b.on('cropped', function (a) {
      i(a.id, a.url);
    });

    // When image cropping is skipped.
    b.on('skippedcrop', function (a) {
      i(a.id, a.get('url'));
    });
    b.on('select', function () {
      var a = b.state().get('selection').first().toJSON();
      var c = a.width / a.height;
      var d = g.params.width / g.params.height;
      if (c === d) {
        var e = b.state().get('selection').single();
        i(e.attributes.id, e.attributes.url);
        b.close();
      } else {
        b.setState('cropper');
      }
    ...
    b.on('open', function () {
      ...
      var c = b.state('library').get('selection');
      c.add(a);
    });
    b.open();
  };
...
/* harmony default export */ __webpack_exports__["default"] = (wpInfoCardImageCrop);
