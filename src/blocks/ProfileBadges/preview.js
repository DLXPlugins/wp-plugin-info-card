...
const Preview = ( props ) => {
	...
	[
  {
	"id": "wporg-contributor",
	"source": "wporg",
	"class": "wporg-badge-contributor",
	"iconType": "dashicon",
...
*/
	...
	// useEffect(() => {
	// 	// Example: if a badge with id 'badge-credits-graduate' is present, ensure 'badge-credits-mentor' is also present
	// 	if ( Array.isArray(badges) ) {
	// 		// Populate badge class with classes in badgeMap.
	// 		const badgeClasses = [];
	// 		badgeMap.forEach((badge) => {
	// 			badgeClasses.push(badge.class);
	// 		});
	// 		setAttributes( { badges: badgeClasses })
	// 	}
	// 	// The effect depends on the badges value changing.
