...
const EditComponent = ( props ) => {
	const [ canSkipAnimatedGifs, setCanSkipAnimatedGifs ] = useState( false );

	return (
		<ScreenshotContext.Provider value={ { canSkipAnimatedGifs, setCanSkipAnimatedGifs } }>
			<Edit { ...props } />
