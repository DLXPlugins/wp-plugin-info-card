			...
			<InspectorControls>
				<PanelBody title={ __( 'WP Plugin Info Card', 'wp-plugin-info-card' ) }>
					...
					<SelectControl
						...
						value={ layout }
						onChange={ ( value ) => {
							this.props.setAttributes( { layout: value } ); this.props.attributes.layout = value; this.setState( { layout: value } ); this.pluginOnClick( value );
						} }
					/>
					<SelectControl
						...
						<Placeholder>
							<div className="wppic-query-block">
								...
								<div>
									...
									<select id="wppic-type-select" onChange={ ( event ) => {
										this.props.setAttributes( { type: event.target.value } ); this.typeChange( event );
									} }>
								...
								<div>
									<input type="text" id="wppic-input-search" value={ this.state.search } onChange={ ( event ) => {
										this.props.setAttributes( { search: event.target.value } ); this.setState( { search: event.target.value } );
									} } />
								</div>
								<div>
								...
								<div>
									<input type="text" id="wppic-input-tag" value={ this.state.tag } onChange={ ( event ) => {
										this.props.setAttributes( { tag: event.target.value } ); this.setState( { tag: event.target.value } );
									} } />
								</div>
								<div>
								...
								<div>
									<input type="text" id="wppic-input-author" value={ this.state.author } onChange={ ( event ) => {
										this.props.setAttributes( { author: event.target.value } ); this.setState( { author: event.target.value } );
									} } />
								</div>
								<div>
								...
								<div>
									<input type="text" id="wppic-input-user" value={ this.state.user } onChange={ ( event ) => {
										this.props.setAttributes( { user: event.target.value } ); this.setState( { user: event.target.value } );
									} } />
								</div>
								...
								<div>
									<select id="wppic-type-browse" onChange={ ( event ) => {
										this.props.setAttributes( { browse: event.target.value } ); this.setState( { browse: event.target.value } );
									} }>
								...
								<div>
									<input type="number" id="wppic-input-per-page" value={ this.state.per_page } onChange={ ( event ) => {
										this.props.setAttributes( { per_page: event.target.value } ); this.setState( { per_page: event.target.value } );
									} } />
								</div>
								<div>
								...
								<div>
									<select id="wppic-input-columns" onChange={ ( event ) => {
										this.props.setAttributes( { cols: event.target.value } ); this.setState( { cols: event.target.value } );
									} }>
								...
								<div>
									<input className="button button-primary" type="submit" id="wppic-input-submit" value={ __( 'Search', 'wp-plugin-info-card' ) } onClick={ ( event ) => {
