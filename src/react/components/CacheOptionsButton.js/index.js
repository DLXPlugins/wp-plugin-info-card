...
/**
 * Cache Options Button.
 *
 * @return {JSX.Element} The Cache Options Button component.
 */
const CacheOptionsButton = ( { nonce } ) => {
	...
	const clearCache = async () => {
		const clearOptionsPromise = SendCommand( 'wppic_clear_cache_options', { nonce } );
...
export default CacheOptionsButton;
