...
(function () {
  ...
  var fetchCard = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(element) {
      var attributesKey, data, response, errorElement;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            attributesKey = element.dataset.username + '_' + element.dataset.repo;
            data = {
              username: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.safeDecodeURIComponent)(element.dataset.username),
              repo: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.safeDecodeURIComponent)(element.dataset.repo),
              nonce: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.safeDecodeURIComponent)(element.dataset.nonce),
              cardAttributes: {}
            };
          ...
          case 1:
            ...
            errorElement.innerHTML = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('GitHub Card data could not be loaded.', 'wp-plugin-info-card');
            element.replaceWith(errorElement);
            return _context.a(2);
          case 2:
            element.outerHTML = response.html;
            return _context.a(2, response.html);
        }
      }, _callee);
    }));
  ...
  var init = function init() {
    ...
    var maybeCards = document.querySelectorAll(DEFAULTS.selector);
    ...
    initialized = true;
    observer = lozad__WEBPACK_IMPORTED_MODULE_3___default()(maybeCards, {
