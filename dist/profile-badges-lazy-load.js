...
"use strict";
/*!********************************************!*\
  !*** ./src/js/profile-badges-lazy-load.js ***!
  \********************************************/
...
(function () {
  ...
  var fetchBadges = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(element) {
      var authorSlug, token, data, response, errorElement, _errorElement, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 2:
            ...
            errorElement.innerHTML = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Profile badges could not be loaded.', 'wp-plugin-info-card');
          ...
          case 4:
            _context.p = 4;
            _t = _context.v;
            _errorElement = document.createElement('div');
            _errorElement.className = 'wppic-profile-badges-error';
            _errorElement.innerHTML = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Profile badges could not be loaded.', 'wp-plugin-info-card');
            element.replaceWith(_errorElement);
          case 5:
            return _context.a(2);
        }
      }, _callee, null, [[1, 4]]);
    }));
    return function fetchBadges(_x) {
  ...
  var init = function init() {
    ...
    var maybeBadges = document.querySelectorAll(DEFAULTS.selector);
    ...
    initialized = true;
    observer = lozad__WEBPACK_IMPORTED_MODULE_2___default()(maybeBadges, {
...
/******/ })()
;
//# sourceMappingURL=profile-badges-lazy-load.js.map