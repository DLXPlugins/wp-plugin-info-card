	...
	public function admin_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'restUrl'                    => Functions::get_rest_url( 'wppic/v1/custom-plugins/import' ),
				'customPluginsRestBase'      => Functions::get_rest_url( 'wppic/v1/plugins/' ),
				'importPluginRestUrl'        => Functions::get_rest_url( 'wppic/v1/custom-plugins/import-from-rest' ),
				'importPluginRestRefreshUrl' => Functions::get_rest_url( 'wppic/v1/custom-plugins/import-from-rest/refresh' ),
