...
$download_label = __( 'Direct Download', 'wp-plugin-info-card' );
...
<div class="wp-pic-large" style="display: none;">
	<div class="wp-pic-large-content">
		<a class="wp-pic-asset-bg" href="<?php echo esc_url( $wppic_data->url ); ?>" target="_blank" title="<?php _e( 'WordPress.org Plugin Page', 'wp-plugin-info-card' ) ?>">
		...
		<div class="wp-pic-half-first">
			<a class="wp-pic-logo" href="<?php echo esc_url( $wppic_data->url ); ?>" <?php echo wp_kses_post( $bgImage ); ?> target="_blank" title="<?php _e( 'WordPress.org Plugin Page', 'wp-plugin-info-card' ) ?>"></a>
            ...
            <?php echo esc_html( $wppic_data->credit ); ?>
		</div>
