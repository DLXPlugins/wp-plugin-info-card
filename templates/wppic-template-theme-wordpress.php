...
<div class="wp-pic-wordpress" style="display: none;">
	<div class="wp-pic-wordpress-content">
		<div class="wp-pic-theme-card-top">
			...
			<h3>
				<a href="<?php echo $wppic_data->url; ?>"  title="<?php printf( __( 'More information about %s', 'wp-plugin-info-card' ), $wppic_data->name ); ?>" target="_blank">
					<?php echo $wppic_data->name ?>
				</a>
				<span class="wp-pic-author"><?php printf( __( 'By %s', 'wp-plugin-info-card' ), $wppic_data->author ) ?></span>
			</h3>
		...
		<div class="wp-pic-theme-card-bottom">
			...
			<div class="wp-pic-column-version">
				<span><?php printf( __( 'Version: %s', 'wp-plugin-info-card' ), $wppic_data->version ) ?></span>
			</div>
		</div>
	</div>
</div>
...
<div class="wp-pic-wordpress theme" style="display: none;">
	<div class="wp-pic-large-content">
		...
		<div class="theme-card-left">
			...
			<div class="theme-author"><?php printf( __( 'By %s', 'wp-plugin-info-card' ), $wppic_data->author ) ?></div>
			<h3 class="theme-name"><?php echo $wppic_data->name ?></h3>

			<div class="theme-actions">
				<a class="button button-primary" href="<?php echo $wppic_data->download_link ?>" title="<?php _e( 'Direct download', 'wp-plugin-info-card' ) ?>"><?php esc_html_e( 'Install', 'wp-plugin-info-card' ); ?></a>
				<a class="button button-secondary preview install-theme-preview" href="<?php echo $wppic_data->preview_url ?>" title="<?php esc_html_e( 'Preview', 'wp-plugin-info-card' ); ?>"><?php esc_html_e( 'Preview', 'wp-plugin-info-card' ); ?></a>
			</div>
		</div>
